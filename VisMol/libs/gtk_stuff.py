...
import VisMol.libs.vaos as vaos
import VisMol.libs.camera as cam
from VisMol.libs.shaders.shaders import vertex_shader, fragment_shader
...
class VMWindow(Gtk.GLArea):
    ...
    def __init__(self, width=350, height=250, **kwargs):
        ...
        self.vert_shader = kwargs.get("vertex_shader", vertex_shader)
        self.frag_shader = kwargs.get("fragment_shader", fragment_shader)
        self.geom_shader = kwargs.get("geometry_shader", None)
        self.draw_type = kwargs.get("draw_type", None)
    ...
    def initialize(self, area):
        ...
        self.bckgrnd_color = np.array([0, 0, 0, 1], dtype=np.float32)
        self.vao = None
        self.elements = None
        self.ctrl = False
